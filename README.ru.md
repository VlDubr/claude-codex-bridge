...
Если синхронный `codex_ask` не укладывается в отведённое время, он не падает: работа переносится в фон, и вы получаете id задачи вместе со всем, что модель успела сделать.
